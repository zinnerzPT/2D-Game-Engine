...
public:
    ...
    //=============================================================
    /** Code extracted from writing to WAV file, this is not part of the original library. */
    //Converts samples to PCM data
...
/** Code extracted from writing to WAV file, this is not part of the original library. */
template <class T>
bool AudioFile<T>::writePCMToBuffer(std::vector<uint8_t>& fileData)
{
	fileData.clear();
